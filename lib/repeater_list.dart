...
class RepeaterList extends StatefulWidget {
  ...
  static final GlobalKey<RepeaterListState> globalKey = GlobalKey<RepeaterListState>();
...
class RepeaterListState extends State<RepeaterList> {
  ...
  static const List<String> allBands = ['10m', '6m', '2m', '1.25m', '70cm', '33cm', '23cm'];
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                onTap: () => {
                  Navigator.push(context, MaterialPageRoute(builder:(context) => RepeaterDetails(repeater)))
                }
              );
            },
          ),
